...
-- NOTE: This one was tricky. We had to use id from movie instead of title because titles are *usually* unique but not always, and this was one of those exceptions.
